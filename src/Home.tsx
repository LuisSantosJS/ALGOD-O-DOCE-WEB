      ...
      <header id="header">
        <div className="container">
          <div id="logo" className="pull-left">
            <a className="scrollto"><img src={require("./assets/img/logo2.png")} alt="" title="" /></a>
          </div>
      ...
      <main id="main">
          ...
          <div className="container" data-aos="fade-up">
            ...
            <div className="row">
              <div className="col-lg-6">
                ...
                <img src={require("./assets/img/escola/portfolio/fachada.jpg")}
              ...
              após sua aposentadoria.</p>
                <img src={require("./assets/img/escola/portfolio/frente_escola.jpg")}
                  className="lazy img-responsive img-thumbnail"
                  alt="Foto da Fachada da Escola"
                  title="Nossa fachada." />
                <br />
                ...
                <img src={require("./assets/img/escola/portfolio/empresa_02.jpg")}
                  className="lazy img-responsive img-thumbnail"
                  alt="Foto da Fachada da Escola"
                  title="Nossa fachada." />
                <br />
                ...
                <br />
                <br />
                <img src={require("./assets/img/escola/portfolio/empresa_03.jpg")}
                ...
                <br />
                <br />
                <img src={require("./assets/img/escola/portfolio/empresa_04.jpg")}
                ...
                <br />
                <img src={require("./assets/img/escola/portfolio/empresa_05.jpg")}
              ...
              <div className="col-lg-6">
                ...
                <img src={require("./assets/img/escola/portfolio/crianca_brincando.jpg")}
                ...
                <br />
                <img src={require("./assets/img/escola/portfolio/instalacoes_01_360w.jpg")}
                  className="lazy img-responsive img-thumbnail" alt="Foto do menino no escorregador."
                  title="Menino no escorregador" />
                <br />
                <br />
                <img src={require("./assets/img/escola/portfolio/instalacoes_20_360w.jpg")}
                  className="lazy img-responsive img-thumbnail" alt="Foto do Banner do Berçário."
                  title="Banner do Berçário." />
                <br />
                <br />
                <img src={require("./assets/img/escola/portfolio/instalacoes_03_360w.jpg")}
                  className="lazy img-responsive img-thumbnail" alt="Foto da Menina Cozinheira."
                  title="Menina Cozinheira" />
                <br />
                <br />
                <img src={require("./assets/img/portfolio/instalacoes_05_360w.jpg")}
                  className="lazy img-responsive img-thumbnail" alt="Foto da Entrada da Escola"
                  title="Entrada da Escola" />
                <br />
                <br />
                <img src={require("./assets/img/escola/portfolio/instalacoes_06_360w.jpg")}
                  className="lazy img-responsive img-thumbnail" alt="Foto do Brinquedo Pula-Pula."
                  title="Brinquedo Pula-Pula" />
                <br />
                <br />
                <img src={require("./assets/img/escola/portfolio/instalacoes_07_360w.jpg")}
                  className="lazy img-responsive img-thumbnail" alt="Foto da Mesa de Refeições"
                  title="Mesa de Refeições" />
                <br />
                <br />
                <img src={require("./assets/img/escola/portfolio/instalacoes_08_360w.jpg")}
                  className="lazy img-responsive img-thumbnail" alt="Foto do bebe no andador."
                  title="Bebe no andador." />
                <br />
                <br />
                <img src={require("./assets/img/escola/portfolio/instalacoes_09_360w.jpg")}
                  className="lazy img-responsive img-thumbnail" alt="Foto dos bebes na sala de berçário."
                  title="Bebes na sala de berçário." />
                <br />
                <br />
                <img src={require("./assets/img/escola/portfolio/instalacoes_10_360w.jpg")}
                  className="lazy img-responsive img-thumbnail" alt="Foto do bebe sorridente."
                  title="Bebe sorridente" />
                <br />
                <br />
                <img src={require("./assets/img/escola/portfolio/instalacoes_11_360w.jpg")}
                  className="lazy img-responsive img-thumbnail" alt="Foto da criança escrevendo."
                  title="Criança escrevendo" />
                <br />
                <br />
                <img src={require("./assets/img/escola/portfolio/instalacoes_12_360w.jpg")}
                  className="lazy img-responsive img-thumbnail" alt="Foto da criança na mesinha de lanches."
                  title="Criança na mesinha de lanches" />
                <br />
                <br />
                <img src={require("./assets/img/escola/portfolio/instalacoes_13_360w.jpg")}
                  className="lazy img-responsive img-thumbnail" alt="Foto do Banner do Jardim."
                  title="Banner do Jardim" />
                <br />
                <br />
                <img src={require("./assets/img/escola/portfolio/instalacoes_14_360w.jpg")}
                  className="lazy img-responsive img-thumbnail" alt="Foto da professora com as crianças no jardim."
                  title="Professora com as crianças no jardim." />
                <br />
                <br />
                <img src={require("./assets/img/escola/portfolio/instalacoes_15_360w.jpg")}
                  className="lazy img-responsive img-thumbnail" alt="Foto da sala de estudos do maternal."
                  title="Sala de estudos do maternal" />
                <br />
                <br />
                <img src={require("./assets/img/escola/portfolio/instalacoes_17_360w.jpg")}
                  className="lazy img-responsive img-thumbnail" alt="Foto da bebe desenhando."
                  title="Bebe desenhando" />
                <br />
                <br />
                <img src={require("./assets/img/escola/portfolio/instalacoes_18_360w.jpg")}
                  className="lazy img-responsive img-thumbnail" alt="Foto da sala do maternal."
                  title="Sala do maternal" />
                <br />
                <br />
                <img src={require("./assets/img/escola/portfolio/instalacoes_19_360w.jpg")}
                  className="lazy img-responsive img-thumbnail" alt="Foto da sala do maternal."
                  title="Sala do maternal" />
                <br />
                <br />
            ...
            <div className="row">
              <div className="col-lg-4 col-md-6">
                <div className="turma" data-aos="fade-up" data-aos-delay="100">
                  <img src={require("./assets/img/turmas/bercario_360w.jpg")} alt="turma 1" className="img-fluid" />
                  <div className="details">
                    <h3><a href="turma-details.html">Berçário</a></h3>
                    <p>Crianças entre 0 e 1 ano e 11 meses.</p>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="turma" data-aos="fade-up" data-aos-delay="200">
                  <img src={require("./assets/img/turmas/maternal_360w.jpg")} alt="turma 2" className="img-fluid" />
                  <div className="details">
                    <h3><a href="turma-details.html">Maternal I</a></h3>
                    <p>Crinças entre 2 anos e 2 anos e 11 meses.</p>
                    <div className="social">
                      <a href=""><i className="fa fa-twitter"></i></a>
                      <a href=""><i className="fa fa-facebook"></i></a>
                      <a href=""><i className="fa fa-google-plus"></i></a>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="turma" data-aos="fade-up" data-aos-delay="300">
                  <img src={require("./assets/img/turmas/maternal_360w.jpg")} alt="turma 3" className="img-fluid" />
                  <div className="details">
                    <h3><a href="#">Maternal II</a></h3>
                    <p>Crinças entre 3 anos e 3 anos e 11 meses.</p>
                    <div className="social">
                      <a href=""><i className="fa fa-twitter"></i></a>
                      <a href=""><i className="fa fa-facebook"></i></a>
                      <a href=""><i className="fa fa-google-plus"></i></a>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="turma" data-aos="fade-up" data-aos-delay="100">
                  <img src={require("./assets/img/turmas/jardim_360w.jpg")} alt="turma 4" className="img-fluid" />
                  <div className="details">
                    <h3><a href="#">Jardim</a></h3>
                    <p>Crinças entre 4 anos e 5 anos e 11 meses.</p>
                    <div className="social">
                      <a href=""><i className="fa fa-twitter"></i></a>
                      <a href=""><i className="fa fa-facebook"></i></a>
                      <a href=""><i className="fa fa-google-plus"></i></a>
        ...
        <section id="gallery">
          ...
          <div className="owl-carousel gallery-carousel" data-aos="fade-up" data-aos-delay="100">
            <a href={require("./assets/img/portfolio/dia_dos_pais_2017/001.jpg")} className="venobox" data-gall="gallery-carousel"><img
              src={require("./assets/img/portfolio/dia_dos_pais_2017/001.jpg")} alt="" /></a>
            <a href={require("./assets/img/portfolio/dia_dos_pais_2017/002.jpg")} className="venobox" data-gall="gallery-carousel"><img
              src={require("./assets/img/portfolio/dia_dos_pais_2017/002.jpg")} alt="" /></a>
            <a href={require("./assets/img/portfolio/dia_dos_pais_2017/003.jpg")} className="venobox" data-gall="gallery-carousel"><img
              src={require("./assets/img/portfolio/dia_dos_pais_2017/003.jpg")} alt="" /></a>
            <a href={require("./assets/img/portfolio/dia_dos_pais_2017/004.jpg")} className="venobox" data-gall="gallery-carousel"><img
              src={require("./assets/img/portfolio/dia_dos_pais_2017/004.jpg")} alt="" /></a>
            <a href={require("./assets/img/portfolio/dia_dos_pais_2017/005.jpg")} className="venobox" data-gall="gallery-carousel"><img
              src={require("./assets/img/portfolio/dia_dos_pais_2017/005.jpg")} alt="" /></a>
            <a href={require("./assets/img/portfolio/dia_dos_pais_2017/006.jpg")} className="venobox" data-gall="gallery-carousel"><img
              src={require("./assets/img/portfolio/dia_dos_pais_2017/006.jpg")} alt="" /></a>
            <a href={require("./assets/img/portfolio/dia_dos_pais_2017/007.jpg")} className="venobox" data-gall="gallery-carousel"><img
              src={require("./assets/img/portfolio/dia_dos_pais_2017/007.jpg")} alt="" /></a>
            <a href={require("./assets/img/portfolio/dia_dos_pais_2017/008.jpg")} className="venobox" data-gall="gallery-carousel"><img
              src={require("./assets/img/portfolio/dia_dos_pais_2017/008.jpg")} alt=""/></a>
            <a href={require("./assets/img/portfolio/dia_dos_pais_2017/009.jpg")} className="venobox" data-gall="gallery-carousel"><img
              src={require("./assets/img/portfolio/dia_dos_pais_2017/009.jpg")} alt="" /></a>
            <a href={require("./assets/img/portfolio/dia_dos_pais_2017/010.jpg")} className="venobox" data-gall="gallery-carousel"><img
              src={require("./assets/img/portfolio/dia_dos_pais_2017/010.jpg")} alt="" /></a>
            <a href={require("./assets/img/portfolio/dia_dos_pais_2017/011.jpg")} className="venobox" data-gall="gallery-carousel"><img
              src={require("./assets/img/portfolio/dia_dos_pais_2017/011.jpg")} alt="" /></a>
            <a href={require("./assets/img/portfolio/dia_dos_pais_2017/012.jpg")} className="venobox" data-gall="gallery-carousel"><img
              src={require("./assets/img/portfolio/dia_dos_pais_2017/012.jpg")} alt="" /></a>
            <a href={require("./assets/img/portfolio/dia_dos_pais_2017/013.jpg")} className="venobox" data-gall="gallery-carousel"><img
              src={require("./assets/img/portfolio/dia_dos_pais_2017/013.jpg")} alt="" /></a>
            <a href={require("./assets/img/portfolio/dia_dos_pais_2017/014.jpg")} className="venobox" data-gall="gallery-carousel"><img
              src={require("./assets/img/portfolio/dia_dos_pais_2017/014.jpg")} alt="" /></a>
            <a href={require("./assets/img/portfolio/dia_dos_pais_2017/015.jpg")} className="venobox" data-gall="gallery-carousel"><img
              src={require("./assets/img/portfolio/dia_dos_pais_2017/015.jpg")} alt="" /></a>
            <a href={require("./assets/img/portfolio/dia_dos_pais_2017/016.jpg")} className="venobox" data-gall="gallery-carousel"><img
              src={require("./assets/img/portfolio/dia_dos_pais_2017/016.jpg")} alt="" /></a>
            <a href={require("./assets/img/portfolio/dia_dos_pais_2017/017.jpg")} className="venobox" data-gall="gallery-carousel"><img
              src={require("./assets/img/portfolio/dia_dos_pais_2017/017.jpg")} alt="" /></a>
            <a href={require("./assets/img/portfolio/dia_dos_pais_2017/018.jpg")} className="venobox" data-gall="gallery-carousel"><img
              src={require("./assets/img/portfolio/dia_dos_pais_2017/018.jpg")} alt="" /></a>
        ...
        <section id="contact" className="section-bg">
          ...
          <div className="container" data-aos="fade-up">
            ...
            <div className="form">
              <form action="https://formspree.io/xdokenkz" role="form" className="php-email-form">
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg-3 col-md-6 footer-info">
                <img src={require("./assets/img/logo2.png")} alt="TheEvenet" />
